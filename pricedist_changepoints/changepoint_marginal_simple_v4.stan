functions {
  ...
  vector compute_change_magnitudes(array[,] int histogram_cumulative, vector price_points)
  {
      ...
      for (t in 2:n_time_points) {
          vector[n_price_points] histogram_prev = extract_segment_histogram(t - 20, t - 1, histogram_cumulative);
          vector[n_price_points] histogram_curr = extract_segment_histogram(t,     t + 20,    histogram_cumulative);
